...
const listClasses: Record<Variant, string> = {
  pill: "inline-flex items-end gap-1 rounded-full bg-card ",
  underline: "inline-flex items-end gap-1 border-border",
  segment: "inline-flex items-end gap-0 rounded-lg bg-card ",
};
  ...
  if (variant === "underline") {
    return (
      <button
        ...
        className={cn(
          "relative isolate px-3 -mb-px text-sm font-medium transition-colors min-h-[52px] inline-flex items-center",
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        onClick={() => setValue(value)}
        className={cn(
          "relative z-10 inline-flex items-center justify-center whitespace-nowrap bg-transparent text-sm font-medium outline-none",
          "transition-colors",
          active
